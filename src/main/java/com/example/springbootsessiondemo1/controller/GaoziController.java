...
//    {
//        gaoziService.insertGaozi(gaozi);
//        return success();
//    }
    @PostMapping
    public AjaxResult updateStatus(@RequestBody Gaozi gaozi)
    {
        gaoziService.updateStatus(gaozi);
        return success();
    }
    ...
    {
        gaoziService.updateGaozi(gaozi);
        return success();
    }
    ...
    {
        gaoziService.deleteGaoziByIds(ids);
        return success();
    }
}
